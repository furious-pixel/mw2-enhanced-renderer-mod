...
CONFIG_SCHEMA = {
    ...
    "HUD": {
        ...
        "targeting_animation_trail_ms": (15.0, 0.0, 250.0),
...
CONFIG_HELP = {
    ...
    "HUD": {
        ...
        "targeting_animation_trail_ms": "Set motion-trail length in milliseconds; zero disables the trail. Grows from zero at acquisition start and requires a nonzero animation duration.",
